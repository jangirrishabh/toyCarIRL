...
class GameState:
    def __init__(self, weights):
        ...
        self.obstacles = []
        self.obstacles.append(self.create_obstacle([[270, 150],[270, 530],[250, 530], [250, 150]] , "yellow", [0,0], 10))
        self.obstacles.append(self.create_obstacle([[420, 150],[420, 530],[400, 530], [400, 150]] , "yellow",[0,0], 10))
        self.obstacles.append(self.create_obstacle([[570, 150],[570, 530],[550, 530], [550, 150]] , "blue",[0,0], 10))
        self.obstacles.append(self.create_obstacle([[720, 150],[720, 530],[700, 530], [700, 150]] , "blue",[0,0], 10))
    ...
    def create_obstacle(self, vertices, color, offset, radius):
        c_body = pymunk.Body(pymunk.inf, pymunk.inf)
        c_shape = pymunk.Poly(c_body,vertices,  offset, radius)
